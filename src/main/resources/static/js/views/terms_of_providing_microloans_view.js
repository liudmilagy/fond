...
function bigForm(width) {
    ...
    var xhr = webix.ajax().sync().get("/terms_of_providing_microloans_info");
    webix.ui({
        id: 'content',
        css: 'fond_bg2',
        type:"space",
        ...
        body: {
            ...
            cols: [
                lft_wdth,
                Form('tab_file', 'terms_of_providing_microloans_files/'),
                rght_wdth,
            ]
        }
    }, $$('content'));

    $$('headerId').setValue("Правила предоставления микрозаймов");
